...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /**/
  LL_GPIO_ResetOutputPin(GPIOE, MCU_RLY_nA_Pin|MCU_RLY_OUT_Pin|MCU_RLY_uA_Pin);
  ...
  /**/
  GPIO_InitStruct.Pin = MCU_G1_Pin|MCU_G100_Pin|MCU_G10_Pin|MCU_ZOFFS_Pin;
  ...
  /**/
  GPIO_InitStruct.Pin = MCU_RLY_nA_Pin|MCU_RLY_OUT_Pin|MCU_RLY_uA_Pin|MCU_RLY_mA_Pin;
  GPIO_InitStruct.Mode = LL_GPIO_MODE_OUTPUT;
  GPIO_InitStruct.Speed = LL_GPIO_SPEED_FREQ_HIGH;
  GPIO_InitStruct.OutputType = LL_GPIO_OUTPUT_PUSHPULL;
  GPIO_InitStruct.Pull = LL_GPIO_PULL_NO;
